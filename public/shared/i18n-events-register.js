...
(function () {
  ...
  var Z = {
    ...
    // ----- 折扣碼（2026-09-23）-----
    rgDiscTitle: '折扣碼',
    rgDiscPlaceholder: '輸入折扣碼',
    rgDiscApply: '套用',
    rgDiscChecking: '檢查中⋯',
    rgDiscOk: '已套用折扣碼',
    rgDiscInvalid: '折扣碼無效',
    rgDiscFail: '無法驗證折扣碼，請稍後再試',
    rgDiscBase: '基本報名費',
    rgDiscGroup: '團報優惠',
    rgDiscCode: '折扣碼折抵',
  ...
  var E = {
    ...
    rgSumFree: 'Free',
    rgSumTotal: 'Total',
    // ----- discount code (2026-09-23) -----
    rgDiscTitle: 'Discount code',
    rgDiscPlaceholder: 'Enter discount code',
    rgDiscApply: 'Apply',
    rgDiscChecking: 'Checking…',
    rgDiscOk: 'Discount code applied',
    rgDiscInvalid: 'Invalid discount code',
    rgDiscFail: 'Could not verify the code, please try again later',
    rgDiscBase: 'Base fee',
    rgDiscGroup: 'Group discount',
    rgDiscCode: 'Code discount',
