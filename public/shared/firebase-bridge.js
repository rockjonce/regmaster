...
(function () {
  ...
  var _argMap = {
    ...
    requestTeamPasswordReset:["teamId"],
    verifyTeamResetToken:["token"],
    resetTeamPassword:["token","newPassword"],
    ...
    savePayoutAccount:["bankCode","bankName","branchCode","branchName","accountNumber","accountName"],
    deleteOwnAccount:[],
    saveGeminiKeys:["keys"],
    ...
    clearAuditLogs:[],
    getRefundTemplates:[],
    getRefundPreview:["compId","teamId","password"],
    requestRefund:["compId","teamId","password","refundAccount","reason"],
    withdrawRefund:["teamId","password"],
    listRefundRequests:["compId"],
    decideRefund:["reqId","action","note"],
    markRefunded:["reqId","actualRefund","refundMethod","refundProof"],
    ...
    getOrganizerBilling:["fromDate","toDate","creator"],
    ...
    getSettlementData:["creator","compId"],
    createSettlement:["creator","note"],
    migratePayoutStates:[],
