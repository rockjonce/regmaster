...
(function () {
  ...
  var Z = {
    ...
    aeFormCtPrevToggle: '點擊展開／收合完整內容',
    aeFormContentOverPre: '超出 ', aeFormContentOverSuf: ' 字，儲存時會被擋下，請縮減',
    aeFormContentTooLongA: '「', aeFormContentTooLongB: '」的顯示文字共 ', aeFormContentTooLongC: ' 字，超過上限 {max} 字——請縮減內容後再儲存（不會自動截斷，以免內容毀損）。',
    aeFormInsOptsBilingualHint: '選項可用「中文 English」格式（中文段限全中文、中英間空一格）：英文介面只顯示英文段、中文介面顯示完整兩段。',
    aeFormPreviewPopupBlocked: '預覽視窗被瀏覽器攔截了——請允許本站的彈出式視窗後再試一次。',
    aeFormManyPagesWarn: '目前有 {n} 個區塊，報名者將分 {p} 頁填寫（一個區塊一頁）。頁數較多時報名流程會比較長，確定要以此頁數儲存嗎？',
  ...
  var E = {
    ...
    aeFormCtPrevToggle: 'Click to expand / collapse full content',
    aeFormContentOverPre: '', aeFormContentOverSuf: ' over the limit — saving will be blocked, please shorten',
    aeFormContentTooLongA: 'Display text of “', aeFormContentTooLongB: '” is ', aeFormContentTooLongC: ' characters, exceeding the {max} limit. Please shorten it before saving (it will not be silently truncated).',
    aeFormInsOptsBilingualHint: "Tip: options in the format '中文 English' (CJK part first, space-separated) show only the English part in the English UI; the Chinese UI shows both parts.",
    aeFormPreviewPopupBlocked: 'The preview window was blocked by the browser — please allow pop-ups for this site and try again.',
    aeFormManyPagesWarn: 'This form has {n} sections, so registrants will fill it in across {p} pages (one section per page). More pages means a longer flow — save with this page count?',
