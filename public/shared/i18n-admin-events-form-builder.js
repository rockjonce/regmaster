...
(function () {
  ...
  var Z = {
    ...
    aeFormContentTooLongA: '「', aeFormContentTooLongB: '」的顯示文字共 ', aeFormContentTooLongC: ' 字，超過上限 8,000 字——請縮減內容後再儲存（不會自動截斷，以免內容毀損）。',
  ...
  var E = {
    ...
    aeFormContentTooLongA: 'Display text of “', aeFormContentTooLongB: '” is ', aeFormContentTooLongC: ' characters, exceeding the 8,000 limit. Please shorten it before saving (it will not be silently truncated).',
