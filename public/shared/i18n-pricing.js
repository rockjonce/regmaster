...
(function () {
  ...
  var Z = {
    ...
    prFaqA2: '手續費依方案而定（實際費率以上方比較表 / 各方案設定為準），以報名者實際線上付款金額計算。平台代收後扣除手續費，再依轉帳週期撥款至你的收款帳戶。<b>銀行 / ATM 轉帳由報名者直接匯入主辦方帳戶，平台不收手續費。</b>',
  ...
  var E = {
    ...
    prFaqA2: 'The fee depends on your plan (see the comparison table above / your plan settings for the exact rate) and is based on the amount registrants actually pay online. The platform collects the payment, deducts the fee, then pays out to your account on the transfer schedule. <b>Bank / ATM transfers go directly into the organizer\'s account, with no platform fee.</b>',
