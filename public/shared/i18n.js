...
(function () {
  window.I18N = {
    zh: {
      ...
      teamSettings: '隊伍設定', cnName: '中文隊名', enName: '英文隊名', stuCount: '報名者數', tchCount: '教練/家長/指導老師 人數',
      stuFields: '報名者欄位', tchFields: '教練/家長/指導老師 欄位', payment: '付款', transfer: '匯款', creditCard: '信用卡',
  ...
  var ADD = {
    zh: {
      ...
      priceForever: '/永久免費', priceYear: '/年', pfNoCard: '無需信用卡', pfNoTax: '含稅', badgePopular: 'Most Popular',
    ...
    en: {
      ...
      priceForever: '/forever free', priceYear: '/yr', pfNoCard: 'No credit card', pfNoTax: 'Tax included', badgePopular: 'Most Popular',
